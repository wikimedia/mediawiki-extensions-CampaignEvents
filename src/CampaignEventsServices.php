...
class CampaignEventsServices {
	...
	public static function getDiscoveryPromotionStore(
		?ContainerInterface $services = null
	): IDiscoveryPromotionStore {
		return ( $services ?? MediaWikiServices::getInstance() )->get( IDiscoveryPromotionStore::STORE_SERVICE_NAME );
	}

	public static function getDiscoverableEventsLookup(
		?ContainerInterface $services = null
	): DiscoverableEventsLookup {
		return ( $services ?? MediaWikiServices::getInstance() )->get( DiscoverableEventsLookup::SERVICE_NAME );
	}
	...
	public static function getEventContributionComputeMetrics(
		?ContainerInterface $services = null
	...
	public static function getWorklistEventsStore( ?ContainerInterface $services = null ): WorklistEventsStore {
		return ( $services ?? MediaWikiServices::getInstance() )->get( WorklistEventsStore::SERVICE_NAME );
	}
